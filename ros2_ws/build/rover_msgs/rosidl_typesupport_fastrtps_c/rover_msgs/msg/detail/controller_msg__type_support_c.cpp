...
#include "rover_msgs/msg/detail/controller_msg__rosidl_typesupport_fastrtps_c.h"
...
using _ControllerMsg__ros_msg_type = rover_msgs__msg__ControllerMsg;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rover_msgs__msg__ControllerMsg;
    is_plain =
      (
...
static size_t _ControllerMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_msgs__msg__ControllerMsg(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_msgs, msg, ControllerMsg)() {
